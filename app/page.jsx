  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 w-full flex flex-col">
      ...
      {(!isAuthenticated || !roles.isAttendee) && (
        <section id="search-section" className="w-full sm:py-16 md:py-20  dark:bg-gray-900 bg-gray-50 dark:bg-gray-800">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-4 text-white">
                            ...
                            <div className="space-y-0.5 sm:space-y-1 text-xs sm:text-sm opacity-90">
                              <div className="flex items-center">
                                ...
                                <span className="truncate">{template.category || 'Event Designs'}</span>
                              </div>
            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="text-center mb-12 sm:mb-16">
                ...
                <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300">
                  Designs in the "{selectedCategory}" category
                </p>
              </div>
              ...
              {isCategoryLoading ? (
                          ...
                          <div className="space-y-0.5 sm:space-y-1 lg:space-y-1.5 text-xs sm:text-sm lg:text-base opacity-90">
                            <div className="flex items-center">
                              ...
                              <span className="truncate">
                                {template.category || 'Event Design'}
                              </span>
                            </div>
                          </div>
                        </div>
                ...
                <div className="text-center py-12">
                  <Search className="h-16 w-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                    No design found in "{selectedCategory}"
                  </h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Hundreds of professionally designed designs for every
                occasion.
              </p>
            </div>
          </div>
