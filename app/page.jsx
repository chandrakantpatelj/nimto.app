          ...
          <div className="space-y-8">
            <div className="space-y-4">
              {isAuthenticated ? (
                <>
                  ...
                  <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                    {roles.isAttendee ? (
                      ...
                      <>
                        Ready to create stunning templates and manage your
                ...
                <>
                  ...
                  <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                    Design stunning invitations, manage RSVPs, and host
                    unforgettable events with our all-in-one platform.
                  </p>
                </>
              )}
            </div>
              ...
              <div className="mt-16">
                ...
                {eventsLoading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {invitedEvents.slice(0, 3).map((event) => {
                      ...
                      return (
                        <div
                          key={event.id}
                          className="p-6 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-lg transition-shadow"
                        >
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      You haven't been invited to any events yet. Check back
                      later!
                    </p>
                  </div>
                )}
            ...
            <div className="mt-16 space-y-6">
              {isAuthenticated ? (
                ...
                <>
                  <p className="text-lg text-gray-600 dark:text-gray-300">
                    Join thousands of event organizers creating memorable
                    experiences!
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
