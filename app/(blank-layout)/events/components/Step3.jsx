...
import { Search, Settings, UserPlus, X, Lock, Users, Calendar, Baby, Shield, Edit2, Upload } from 'lucide-react';
...
function Step3() {
    ...
    const [editGuestData, setEditGuestData] = useState({ name: '', email: '', phone: '' });
    ...
    const handleExcelFileChange = (e) => {
        ...
        reader.onload = (evt) => {
            ...
            if (newGuests.length > 0) {
                ...
                toastSuccess(`${newGuests.length} guest${newGuests.length > 1 ? 's' : ''} imported successfully.`);
            }
                                ...
                                <div className="space-y-6 sm:space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-col lg:flex-row gap-4">
                                            ...
                                            <div className="flex items-end lg:items-end gap-2">
                                                <Button
                                                    variant="primary"
                                        ...
                                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mb-6">
                                            ...
                                            <div className="flex items-center gap-2 sm:gap-3">
                                                <Button
                                                    ...
                                                    className="flex items-center gap-2 px-4 py-2 font-semibold shadow-sm"
                                                >
