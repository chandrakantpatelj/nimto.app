      ...
      <div className="flex items-center justify-between mb-2">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-2 ml-12">
            Manage and monitor all events across the entire system
          </p>
        </div>
      </div>
              ...
              <div className="relative aspect-[3/4] overflow-hidden">
                {event?.eventThumbnailUrl || event?.s3ImageUrl ? (
                  <>
                    ...
                    <div
                      className="w-full h-full bg-gray-50 items-center justify-center"
                      style={{ display: 'none' }}
                    >
                ...
                <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-10">
                  <Button
                    ...
                    className="h-9 w-9 p-0 bg-white/95 hover:bg-white shadow-lg border-0 backdrop-blur-sm cursor-pointer"
                  >
                  ...
                  <Button
                    ...
                    className="h-9 w-9 p-0 bg-white/95 hover:bg-red-50 shadow-lg border-0 backdrop-blur-sm cursor-pointer"
                  >
