...
export default function InvitedEventsPage() {
    ...
    const { upcoming, past } = useMemo(() => splitEvents(dedupedEvents), [dedupedEvents]);
    ...
    const renderEventCard = (event, isPast) => {
        ...
        return (
            <div key={event.id} className="flex bg-gray-50 rounded-lg p-6 mb-6 shadow-sm items-center">
                ...
                <div className="flex-1 ml-8">
                    ...
                    <div className="text-gray-700 mb-1">
                        ...
                        {event.startDateTime && (
                            <>
                                {' '}
                                {formatTime(event.startDateTime)} ET
                            </>
                        )}
                    </div>
        ...
        return (
            <div className="flex items-center justify-center h-64">
                <div className="text-center">
                    ...
                    <Button onClick={fetchInvitedEvents} className="mt-4" variant="outline">
                        Try Again
                    </Button>
                </div>
            </div>
