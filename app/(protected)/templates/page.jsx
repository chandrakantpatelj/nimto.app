      ...
      <Fragment>
        ...
        <Container>
          <div className="py-8 sm:py-12 md:py-16">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-8 sm:mb-10 md:mb-12 text-center px-4 sm:px-0">
              What do you want to do today?
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 px-4 sm:px-0">
              <div className="group bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2 border border-blue-200">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Make an Invitation</h3>
                <p className="text-gray-600 mb-4 sm:mb-6 text-xs sm:text-sm leading-relaxed">Let's get the party started.</p>
              ...
              <div className="group bg-gradient-to-br from-green-50 to-green-100 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2 border border-green-200">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Upload your own</h3>
                <p className="text-gray-600 mb-4 sm:mb-6 text-xs sm:text-sm leading-relaxed">Add your own design, photo, or logo.</p>
              ...
              <div className="group bg-gradient-to-br from-purple-50 to-purple-100 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2 border border-purple-200">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Send a gift instantly</h3>
                <p className="text-gray-600 mb-4 sm:mb-6 text-xs sm:text-sm leading-relaxed">Shop eGift Cards from top retailers.</p>
              ...
              <div className="group bg-gradient-to-br from-orange-50 to-orange-100 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl text-center hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2 border border-orange-200">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Create a SignUp Sheet</h3>
                <p className="text-gray-600 mb-4 sm:mb-6 text-xs sm:text-sm leading-relaxed">Organize volunteers and tell them what to bring.</p>
