        ...
        <Card className="p-8">
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-700">
                  <span className="font-medium">Type:</span> {template.isPremium ? 'Premium' : 'Free'}
                </p>
                {template.isPremium && (
                  <p className="text-gray-700">
          ...
          <div>
            ...
            <div 
              ...
              style={{
                background: template.background || template.pageBackground || '#f3f4f6'
              }}
            >
              ...
              >
                ...
                <div className="relative z-10 h-full flex flex-col justify-center items-center text-center">
                  ...
                  <div className="space-y-2 text-gray-700">
                    <p className="text-sm">You're invited to celebrate a special birthday!</p>
            ...
            <p className="text-xs text-gray-500 mt-4 text-center">
              This is an image-based preview generated from the template design for copyright security.
            </p>
          </div>
        </Card>
