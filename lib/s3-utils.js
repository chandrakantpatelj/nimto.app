...
export function getS3Config() {
  return {
    bucket: process.env.AWS_S3_BUCKET || process.env.STORAGE_BUCKET || process.env.NEXT_PUBLIC_AWS_S3_BUCKET || process.env.NEXT_PUBLIC_STORAGE_BUCKET,
    region: process.env.AWS_REGION || process.env.STORAGE_REGION || process.env.NEXT_PUBLIC_AWS_REGION || process.env.NEXT_PUBLIC_STORAGE_REGION || 'us-east-1',
    endpoint: process.env.AWS_ENDPOINT || process.env.STORAGE_ENDPOINT || process.env.NEXT_PUBLIC_AWS_ENDPOINT || process.env.NEXT_PUBLIC_STORAGE_ENDPOINT,
  };
}
